...
protected:
    ...
    ISoftstar_Login_Client* (
        *CreateSoftstarLoginClient)(char* strIPAddr, int iPort, S_CALLBACK* sCallback);
...
#ifndef __SHO_LS_LIB
    enum e_BSReqType { BST_PRELOGIN = 0, BST_LOGIN, BST_LOGOUT, BST_RELOGIN };
    struct tagBSItem {
        e_BSReqType m_eType;
        CStrVAR m_PlayerID;
        CStrVAR m_Password;
...
public:
    ...
    static void PreloginResult(char* strPlayerID,
        ...
        int iLoginState,
        int right);
    static void LoginResult(char* strPlayerID,
        unsigned short u16ChargeType,
        double dPoint,
        unsigned int uIdentity,
        unsigned int uLoginResult,
        int iLoginState);
    static void ReloginResult(char* strPlayerID,
        unsigned short u16ChargeType,
        double dPoint,
    ...
    bool CBS_Taiwan::PreloginToServer(char* szPlayerID,
        char* szPassword,
        char* szIP,
        unsigned int uiUserTAG) {
#ifdef __SHO_LS_LIB
        if (m_pInstance) {
    ...
    bool CBS_Taiwan::LoginToServer(char* szPlayerID,
        char* szPassword,
        char* szIP,
        unsigned int uiUserTAG) {
#ifndef __SHO_LS_LIB
