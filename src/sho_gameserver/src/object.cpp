...
CGameOBJ*
CObjMNG::Get_OBJECT(WORD wIndex) {
    return this->GetData(wIndex);
}

CGameOBJ*
CObjMNG::Get_GameOBJ(WORD wIndex, t_ObjTAG ObjTYPE) {
    CGameOBJ* pObject;
...
classUSER*
CObjMNG::Get_UserOBJ(DWORD dwIndex) {
...
CObjCHAR*
CObjMNG::Get_CharOBJ(WORD wIndex, bool bCheckHP) {
    CGameOBJ* pObject;
...
CObjITEM*
CObjMNG::Get_ItemOBJ(WORD wIndex) {
    CGameOBJ* pObject;
