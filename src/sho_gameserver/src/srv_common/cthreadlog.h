...
// INSERT tblGS_LOG ( dateREG, txtSUBJECT, txtSBJIP, txtACTION, txtLOC, txtITEM, txtOBJECT, txtOBJIP
// ) VALUES( default, @szSUB, @szSBJIP, @szACT, @szLOC, @szITEM,  @szOBJ, @szOBJIP )
#define SP_M_OBJLOG "{call gs_M_ObjLOG(%I64d, \'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\')}"

// INSERT tblGS_LOG ( dateREG, txtSUBJECT, txtSBJIP, txtACTION, txtLOC, txtITEM,txtDESC ) VALUES(
// default, @szSUB, @szSBJIP, @szACT, @szLOC, @szITEM, @szDESC )
#define SP_M_DESCLOG "{call gs_M_DescLOG(%I64d, \'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\')}"

// INSERT tblGS_LOG ( dateREG, txtSUBJECT, txtSBJIP, txtACTION, txtLOC, txtITEM, txtOBJECT,
// txtOBJIP, txtDESC ) VALUES( default, @szSUB, @szSBJIP, @szACT, @szLOC, @szITEM,  @szOBJ,
// @szOBJIP, @szDESC )
#define SP_M_OBJDESCLOG \
    "{call gs_M_ObjDescLOG(%I64d, \'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\')}"

// INSERT tblGS_LOG ( dateREG, txtSUBJECT, txtOBJECT, txtSBJIP, txtACTION, txtLOC ) VALUES(
// \'%s\',\'%s\',\'%s\',\'%s\',\'%s\',\'%s\' );",
