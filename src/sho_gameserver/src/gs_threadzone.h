...
public:
    ...
    void Dec_UserCNT() { ::InterlockedDecrement(&m_lUserCNT); }
    ...
    CObjMOB*
    RegenMOB(float fCenterX, float fCenterY, int iRange, int iIndex, int iCount, int iTeamNO);
    bool RegenCharacter(CObjMOB* pNewMOB,
        float fCenterX,
        float fCenterY,
        int iRange,
        int iIndex,
        int iTeamNO);
    CObjMOB* RegenCharacter(float fCenterX,
        float fCenterY,
        int iRange,
        int iIndex,
        int iCount,
    ...
    inline int Get_EconomyVAR(short nVarIDX) { return m_Economy.Get_EconomyVAR(nVarIDX); }
