...
public:
    ...
    tagEVENTPOS*
    Add_EventPOS(t_HASHKEY HashKEY, short nZoneNO, char* szPosName, float fXPos, float fYPos);
    ...
    CObjMOB* RegenCharacter(short nZoneNO,
        float fCenterX,
        float fCenterY,
        int iRange,
        int iIndex,
