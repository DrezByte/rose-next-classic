...
//---------------------------------------------------------------------------------------
tPOINTF
WS_Zone::Get_RevivePOS(tPOINTF PosCUR) {
...
//---------------------------------------------------------------------------------------
void
WS_ZoneLIST::Set_WorldVAR(short nVarIDX, short nValue) {
    ...
    for (short nY = 1; nY < m_nZoneCNT; nY++) {
        ...
        if (ZONE_FILE(nY)) {
            ...
            if (this->LoadZONE(szBaseDIR, nY)) {
                ...
                _ASSERT(
                    this->m_pZONE[nY].m_PosREVIVE.x != 0 && this->m_pZONE[nY].m_PosREVIVE.y != 0);
            }
        }
    }
...
bool
WS_ZoneLIST::LoadZONE(char* szBaseDIR, short nZoneNO) {
    FILE* fp;
    char* szZoneFILE;
...
//-------------------------------------------------------------------------------------------------
void
WS_ZoneLIST::ReadZoneINFO(FILE* fp, long lOffset) {
    int iValue;
    float fValue;
...
void
WS_ZoneLIST::ReadEventObjINFO(FILE* fp, long lOffset, short nZoneNO) {
    int iEventPosCNT;
...
//-------------------------------------------------------------------------------------------------
tagEVENTPOS*
WS_ZoneLIST::Add_EventPOS(t_HASHKEY HashKEY,
    short nZoneNO,
    char* szPosName,
    float fXPos,
    float fYPos) {
...
//---------------------------------------------------------------------------------------
tagEVENTPOS*
WS_ZoneLIST::Get_EventPOS(short nZoneNO, char* szPosName) {
