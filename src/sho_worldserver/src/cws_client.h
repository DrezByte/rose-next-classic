...
private:
    ...
    bool IsHacking(const char* szDesc, const char* szFile, int iLine);
...
public:
    ...
    bool SendPacket(const classPACKET& pCPacket) { return this->Send_Start(pCPacket); }
...
public:
    ...
    bool SendPacketToSocketIDX(int iClientSocketIDX, const classPACKET& pCPacket);
