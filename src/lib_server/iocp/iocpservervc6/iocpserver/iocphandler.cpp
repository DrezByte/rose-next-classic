...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
IocpHandler::Create(int nMaxNumberOfConcurrentThreads, int* pnOutErrCode) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
IocpHandler::Associate(SOCKET hSocket, ULONG_PTR CompletionKey, int* pnOutErrCode) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
IocpHandler::Associate(HANDLE hDevice, ULONG_PTR CompletionKey, int* pnOutErrCode) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
IocpHandler::PostCompletionStatus(ULONG_PTR CompletionKey,
...
// piProcessThread: IIocpProcessThread 인터페이스를 상속받은 클래스에 대한 포인터 즉 쓰레드 풀에
// 들어갈
...
///////////////////////////////////////////////////////////////////////////////////////////////////
BOOL
IocpHandler::CreateThreadPool(IIocpProcessThread* piProcessThread, int nNumOfPooledThread) {
