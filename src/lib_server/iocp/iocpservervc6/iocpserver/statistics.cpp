...
void
Statistics::CalcStatistics(void) {
...
void
Statistics::IncreaseBytesSent(DWORD dwBytesTransferred) {
...
void
Statistics::IncreaseBytesRead(DWORD dwBytesTransferred) {
    EnterCriticalSection(&m_cs);
...
BOOL CALLBACK
Statistics::DlgProc(HWND hwndDlg, UINT message, WPARAM wParam, LPARAM lParam) {
