...
public:
    classMYSQL(short nBindParamCNT = MAX_MYSQL_BIND_PARAMETER,
        WORD wQueryBufferLEN = MAX_MYSQL_QUERY_BUFFER);
    ~classMYSQL();
    ...
    bool GetTimestamp(WORD wColumnIDX, sqlTIMESTAMP* pTimeStamp) { return false; }
};
