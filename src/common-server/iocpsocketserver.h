...
public:
    ...
    virtual void ClosedClientSOCKET(
        iocpSOCKET* pCLIENT) = 0; // 소켓이 삭제됐다.. 알아서 메모리 해제할것...
...
private:
    ...
    inline void
    STATUS_ReturnTRUE(LPOVERLAPPED lpOverlapped, DWORD dwCompletionKey, DWORD dwBytesIO) {
