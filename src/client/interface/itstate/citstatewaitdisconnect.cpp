...
CITStateWaitDisconnect::Enter() {
    ...
    if (CTDialog* pDlg = g_itMGR.FindDlg(DLG_TYPE_MSGBOX_SPECIAL)) {
        ...
        g_itMGR.OpenDialog(DLG_TYPE_MSGBOX_SPECIAL,
            false,
...
unsigned
CITStateWaitDisconnect::Process(unsigned uiMsg, WPARAM wParam, LPARAM lParam) {
...
void
CITStateWaitDisconnect::Update(POINT ptMouse) {
