 ...
 *
 * @Warning		현재(2005/9/6) 한국의 경우 채널서버가 1개이고 채널 리스트를 보여주지 않는다.그 외
 * 국가는 모두 채널서버가 2개 이상으로 선택을 할 수 있다.
 * @Author		최종진
 * @Date			2005/9/6
 */
...
public:
    ...
    enum { IID_LISTBOX_SERVER = 2, IID_LISTBOX_CHANNEL = 3, IID_BTN_OK = 10, IID_BTN_CANCEL = 11 };
