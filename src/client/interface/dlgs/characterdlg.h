 ...
 *
 * @Warning		현재(2005/9/12) 대만(New)버젼에는 조합 정보를 보여주지 않는다( XML에서 탭버튼을
 * 없애서 탭을 이동할수 없도록 되어 있다 )
 * @Author		최종진
 * @Date			2005/9/12
 */
...
protected:
    enum { IID_TABABLITY = 0, IID_TABUNION = 1, IID_TABBASIC = 2 };
    enum { BASIC_INFO, ABILITY_INFO, UNION_INFO };
