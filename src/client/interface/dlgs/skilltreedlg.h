 ...
 * @TODO		MSXML의 경우 호환성 문제로 낮은 버젼을 사용중인데 사용중인 버젼에서는 메모리에서 화일을
 *로드 할수 없다.. 그래서 XML의 경우 가상화일시스템을 사용못하고 있다..그래서 테스트겸해서 EXPAT으로
 *구현하였다. 나중에 TGameCtrl에서의 Parser도 교체하는게 좋을듯하다.
 * @Author	최종진
 * @Date		2005/9/15
 */
