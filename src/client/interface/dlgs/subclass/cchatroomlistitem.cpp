...
CChatRoomListItem::CChatRoomListItem(WORD wID,
    BYTE btRoomType,
    BYTE btUserCount,
    const char* pszTitle) {
    SetHeight(20);
...
unsigned
CChatRoomListItem::Process(unsigned uiMsg, WPARAM wParam, LPARAM lParam) {
