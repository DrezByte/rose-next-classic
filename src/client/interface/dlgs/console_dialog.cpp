...
bool ConsoleDialog::Create(int x, int y, int width, int height)
{
	...
	CTImage* background = CTControlMgr::GetInstance()->MakeImage(
		BACKGROUND_ID, x, y, width, height, graphic_id, 0);
