...
//----------------------------------------------------------------------------------------------------
void
CClanSkillSlot::UpdateSkillSlot() {
    CSkill* pSkill = NULL;
...
void
CClanSkillSlot::SetSkillSlot(short nSlotIndex,
    short nSkillIndex,
    short nSkillLevel,
    DWORD expire_time_abssec) {
...
//----------------------------------------------------------------------------------------------------
void
CClanSkillSlot::SkillLevelUp(int iSkillSlotNo, int iSkillIndex) {
...
CSkill*
CClanSkillSlot::GetSkillBySkillIDX(int iSkillIDX) {
    CSkill* pSkill = NULL;
...
//----------------------------------------------------------------------------------------------------
CSkill*
CClanSkillSlot::GetSkillByBaseSkillIDX(int iBaseSkillIDX) {
    CSkill* pSkill = NULL;
...
short
CClanSkillSlot::GetSkillIndex(short nSlotIndex) {
    if (nSlotIndex >= MAX_CLAN_SKILL_SLOT || nSlotIndex < 0 || m_SkillSlot[nSlotIndex] == NULL)
        return 0;
...
short
CClanSkillSlot::GetSkillLevel(short nSlotIndex) {
    if (nSlotIndex >= MAX_CLAN_SKILL_SLOT || nSlotIndex < 0 || m_SkillSlot[nSlotIndex] == NULL)
        return 0;
...
short
CClanSkillSlot::GetSkillDelayTime(short nSlotIndex) {
    if (nSlotIndex >= MAX_CLAN_SKILL_SLOT || nSlotIndex < 0 || m_SkillSlot[nSlotIndex] == NULL)
        return 0;
...
short
CClanSkillSlot::GetSkillIconIndex(short nSlotIndex) {
...
void
CClanSkillSlot::RemoveBySlotIndex(short nSlotIndex) {
