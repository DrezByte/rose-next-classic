...
void
CHotIconSlot::SetHotIcons(CHotICONS* pHotIcon) {
    if (pHotIcon) {
...
void
CHotIconSlot::AddQuickItem(int iSlot, int iType, int iIndex) {
...
//----------------------------------------------------------------------------------------------------
/// @param
/// @brief 해당 슬롯의 정보를 기반으로 적절한( Skill type인지 아이템 타입인지 ) CIcon객체를
/// 생성한다.
//----------------------------------------------------------------------------------------------------

CIcon*
CHotIconSlot::GetHotIcon(int iSlot) {
    CIcon* pIcon = NULL;
...
//----------------------------------------------------------------------------------------------------
tagHotICON
CHotIconSlot::GetHotItem(int iSlot) {
