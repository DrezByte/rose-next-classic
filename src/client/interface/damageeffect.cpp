...
CDamageEffect::Init() {
    ...
    // m_hMotion = ::loadMotion( "DigitEffectMotion", "3DData\\Effect\\Special\\hit_figure_01.ZMO",
    // 1, ZZ_INTERP_CATMULLROM, ZZ_INTERP_SQUAD, 1, 1 ); if( m_hMotion == NULL )
    //{
    //	ClearAll();
    //	return false;
    //}
    ...
    //	hMesh = ::loadMesh ( CStr::Printf ("DigitMesh_%d", i ),
    //"3DData\\Effect\\Special\\DigitWork01.zms" ); 	if( hMesh == NULL )
    //	{
    //		ClearAll();
    //		return false;
    //	}
...
void
CDamageEffect::CreateDigitEffect(int iPoint, float x, float y, float z, bool bIsUSER) {}