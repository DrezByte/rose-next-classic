...
/// 2D version
void
CTDrawImpl::Draw(int iX, int iY, int iModuleID, int iGraphicID) {
    Draw(iX, iY, iModuleID, iGraphicID, D3DCOLOR_RGBA(255, 255, 255, 255));
}

void
CTDrawImpl::Draw(int iX, int iY, int iModuleID, int iGraphicID, D3DCOLOR color) {
...
void
CTDrawImpl::Draw(int iX, int iY, int iWidth, int iModuleID, int iGraphicID, D3DCOLOR color) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
    if (pImageRes == NULL) {
        assert(pImageRes && "Get ImageRes failed");
        return;
    ...
    ::drawSprite(hTexture, &(rcDraw), NULL, &D3DXVECTOR3(0, 0, 0), color);
}

void
CTDrawImpl::Draw(int iX, int iY, int iWidth, int iModuleID, int iGraphicID) {
    Draw(iX, iY, iWidth, iModuleID, iGraphicID, D3DCOLOR_RGBA(255, 255, 255, 255));
}

/// 3D version
void
CTDrawImpl::Draw(float iX, float iY, float iZ, int iModuleID, int iGraphicID, D3DCOLOR color) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
    if (pImageRes == NULL) {
        assert(pImageRes && "Get ImageRes failed");
        return;
...
void
CTDrawImpl::Draw(float iX, float iY, float iZ, int iModuleID, int iGraphicID) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
    if (pImageRes == NULL) {
        assert(pImageRes && "Get ImageRes failed");
        return;
...
void
CTDrawImpl::DrawRotateY(float fX,
    float fY,
    float fZ,
    float fRotateY,
    int iModuleID,
...
void
CTDrawImpl::Draw(float iX, float iY, float iZ, int iWidth, int iModuleID, int iGraphicID) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
...
void
CTDrawImpl::DrawFitW(int iX, int iY, int iModuleID, int iGraphicID, int iWidth, D3DCOLOR color) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
    if (pImageRes == NULL) {
        assert(pImageRes && "Get ImageRes failed");
        return;
...
void
CTDrawImpl::DrawFitH(int iX, int iY, int iModuleID, int iGraphicID, int iHeight, D3DCOLOR color) {
    CImageRes* pImageRes = (CImageResManager::GetSingleton()).GetImageRes(iModuleID);
    if (pImageRes == NULL) {
        assert(pImageRes && "Get ImageRes failed");
        return;
...
int
CTDrawImpl::GetScreenWidth() {
    return getScreenWidth();
}

int
CTDrawImpl::GetScreenHeight() {
