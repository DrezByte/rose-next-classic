...
bool
CTCmdDragInven2QuickBar::Exec(CTObject* pObj) {
    if (pObj == NULL) {
    ...
    if (hotICON.m_nSlotNo < INVENTORY_ITEM_INDEX_0
        || hotICON.m_nSlotNo > INVENTORY_ITEM_INDEX_LAST) {
...
bool
CTCmdDragSkill2QuickBar::Exec(CTObject* pObj) {
    if (pObj == NULL) {
...
bool
CTCmdDragClanSkill2QuickBar::Exec(CTObject* pObj) {
    if (pObj == NULL) {
...
///*------------------------------------------------------------------------------------------------------------*/
bool
CTCmdDragItemFromQuickBar::Exec(CTObject* pObj) {
    if (pObj == NULL) {
    ...
    if (nSlotIndex < 0 || nSlotIndex >= MAX_HOT_ICONS) {
        LogString(LOG_NORMAL,
            "Not Found SlotIndex By Icon Pointer @CTCmdDragItemFromQuickBar::Exec");
        return true;
    }
...
///*------------------------------------------------------------------------------------------------------------*/
bool
CTCmdMoveIconInQuickBar::Exec(CTObject* pObj) {
...
bool
CTCmdDragItemEquipFromInven::Exec(CTObject* pObj) {
    if (pObj == NULL) {
...
bool
CTCmdDragItemFromEquipInItemDlg::Exec(CTObject* pObj) {
    if (pObj == NULL)
        return true;
...
bool
CTCmdDragItemFromInvenInItemDlg::Exec(CTObject* pObj) {
    if (pObj == NULL)
        return true;
...
bool
CTCmdDragItem2PrivateStoreDlg::Exec(CTObject* pObj) {
...
bool
CTCmdDragItem2WishList::Exec(CTObject* pObj) {
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
    }
...
bool
CTCmdDragSellItemFromPrivateStoreDlg::Exec(CTObject* pObj) {
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
    }
...
bool
CTCmdDragBuyItemFromPrivateStoreDlg::Exec(CTObject* pObj) {
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
    }
...
bool
CTCmdDragSellItemFromAvatarStoreDlg::Exec(CTObject* pObj) {
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
    }
...
bool
CTCmdDragItem2SeparateDlg::Exec(CTObject* pObj) {
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
    }
...
bool
CTCmdDragTakeoutTargetItemFromUpgradeDlg::Exec(CTObject* pObj) {
    assert(pObj);
...
bool
CTCmdDragTakeoutMaterialItemFromUpgradeDlg::Exec(CTObject* pObj) {
    assert(pObj);
    if (pObj == NULL || strcmp(pObj->toString(), "CIcon")) {
        assert(0 && "pObj is NULL or Invalid Type");
        return true;
...
bool
CTCmdDragTakeinItem2UpgradeDlg::Exec(CTObject* pObj) {
    if (pObj == NULL)
        return true;
