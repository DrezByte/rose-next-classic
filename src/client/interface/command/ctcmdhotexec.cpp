...
bool
CTCmdReLogin::Exec(CTObject* pObj) {
...
bool
CTCmdRejectTradeReq::Exec(CTObject* pObj) {
    CExchangeDLG* pDlg = g_itMGR.GetExchangeDLG();
    if (pDlg == NULL)
        return true;
...
/*--------------------------------------------------------------------------------------------------------------------------------------*/
bool
CTCmdHideDialog::Exec(CTObject* pObj) {
...
bool
CTCmdSendPacketPartyReply::Exec(CTObject* pObj) {
    g_pNet->Send_cli_PARTY_REPLY(m_btReply, m_wObjSvrIdx);
    return true;
}

bool
CTCmdLeaveParty::Exec(CTObject* pObj) {
    CParty::GetInstance().Leave();
    return true;
}

bool
CTCmdAcceptPartyJoin::Exec(CTObject* pObj) {
...
bool
CTCmdRejectPartyJoin::Exec(CTObject* pObj) {
