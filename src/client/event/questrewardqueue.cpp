...
void
CQuestRewardQueue::PushSetAbility(gsv_SET_ABILITY& sSetAbility) {
    m_SetAbilityList.push_back(sSetAbility);
}

void
CQuestRewardQueue::PushAddAbility(gsv_SET_ABILITY& sAddAbility) {
...
void
CQuestRewardQueue::AddAbility(gsv_SET_ABILITY sSetAbility) {
