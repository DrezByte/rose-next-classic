...
void
CObjectActionProcessor::MakeChain() {
...
void
CObjectActionProcessor::ClearChain() {
    if (m_pRootActionChain != NULL) {
...
void
CObjectActionProcessor::SetNextChain(CActionProcessChain* pChain) {
    if (m_pRootActionChain == NULL) {
...
void
CObjectActionProcessor::ProcessChain(HNODE hNode) {
    if (m_pRootActionChain != NULL)
...
void
CActionProcessChain::DeleteNextChian() {
    if (m_pNextActionChain != NULL) {
...
void
CActionProcessChain::AddNextChain(CActionProcessChain* pNext) {
    if (m_pNextActionChain == NULL) {
...
void
CWarpObjectActionProcessor::ProcessChain(HNODE hNode) {
...
void
CEventObjectActionProcessor::ProcessChain(HNODE hNode) {
    if (g_pAVATAR == NULL)
        return;
