...
//----------------------------------------------------------------------------------------------------
void
CPreventDuplicatedCommand::Init() {
    int i = 0;
    int j = 0;
...
//----------------------------------------------------------------------------------------------------
void
CPreventDuplicatedCommand::ClearCommandQueue() {
...
//----------------------------------------------------------------------------------------------------
void
CPreventDuplicatedCommand::ClearAll() {
    ClearCommandQueue();
...
void
CPreventDuplicatedCommand::Proc() {
    std::list<SendedCommand*>::iterator begin = m_SendedCommandQueue.begin();
    std::list<SendedCommand*>::iterator end = m_SendedCommandQueue.end();
...
CObjCommand*
CPreventDuplicatedCommand::GetObjCommand(int iType) {
...
SendedCommand*
CPreventDuplicatedCommand::GetSendedCommand() {
...
//----------------------------------------------------------------------------------------------------
bool
CPreventDuplicatedCommand::PushSelfSkillCommand(int iSkillSlot) {
    CObjSkill2SelfCommand* pCommand =
        (CObjSkill2SelfCommand*)GetObjCommand(OBJECT_COMMAND_Skill2SELF);
...
//----------------------------------------------------------------------------------------------------
bool
CPreventDuplicatedCommand::PushTargetSkillCommand(int iServerTarget, int iSkillSlot) {
...
//----------------------------------------------------------------------------------------------------
bool
CPreventDuplicatedCommand::PushPositionSkillCommand(D3DVECTOR& PosTO, int iSkillSlot) {
...
bool
CPreventDuplicatedCommand::CanSendSelfSkillCommand(int iSkillSlot) {
    std::list<SendedCommand*>::iterator begin = m_SendedCommandQueue.begin();
    std::list<SendedCommand*>::iterator end = m_SendedCommandQueue.end();
...
bool
CPreventDuplicatedCommand::CanSendTargetSkillCommand(int iServerTarget, int iSkillSlot) {
    std::list<SendedCommand*>::iterator begin = m_SendedCommandQueue.begin();
    std::list<SendedCommand*>::iterator end = m_SendedCommandQueue.end();
...
bool
CPreventDuplicatedCommand::CanSendPositionSkillCommand(D3DVECTOR& PosTO, int iSkillSlot) {
    std::list<SendedCommand*>::iterator begin = m_SendedCommandQueue.begin();
    std::list<SendedCommand*>::iterator end = m_SendedCommandQueue.end();
    ...
    for (; begin != end; ++begin) {
        ...
        if (pCommand->GetType() == OBJECT_COMMAND_Skill2POS) {
            ...
            if (pObjCommand->GetSkillIndex() == iSkillSlot) {
                if (vec.x == PosTO.x && vec.y == PosTO.y && vec.z == PosTO.z) {
                    return false;
                }
            }
        }
