...
int
CChangeActionMode::GetAdjustedActionIndex(int iActionIdx) {
...
//----------------------------------------------------------------------------------------------------
/// @param
/// @brief if avt finished attack command, then change action mode to normal mode after 10 sec from
/// attack end time.
//----------------------------------------------------------------------------------------------------

void
CChangeActionMode::AttackEnd() {
    m_iElapsedAttackEnd = 0;
    m_bUpdateMode = true;
}
