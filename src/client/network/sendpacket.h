...
public:
    ...
    void Send_cli_DAMAGE(CObjCHAR* pAtkOBJ, CObjCHAR* pDefOBJ, int wDamage);
    ...
    void Send_cli_QUEST_REQ(BYTE btReqTYPE,
        BYTE btQuestSLOT,
        int iQuestID,
    ...
    void
    Send_cli_CHAT_ROOM_MAKE(BYTE btRoomTYPE, BYTE btMaxUSER, char* szRoomTitle, char* szPasswd);
    ...
    void Send_cli_CRAFT_UPGRADE_REQ(BYTE btType,
