...
//-------------------------------------------------------------------------------------------------
bool
CAI_EVENT::Load(FILE* fp, STBDATA* pSTB, int iLangCol) {
    ...
    for (int iC = 0; iC < m_iConditionCNT; iC++) {
        ...
        fread(&m_ppConditionLIST[iC]->m_pDATA[sizeof(stCondHead)],
            sizeof(BYTE),
            sCondH.dwSize - sizeof(stCondHead),
            fp);
        ...
        switch (sCondH.Type) {
            ...
            case AICOND_01:
                break;
            case AICOND_02:
                m_ppConditionLIST[iC]->st02.iDistance *= 100;
                ...
                break;
            case AICOND_03:
                m_ppConditionLIST[iC]->st03.iDistance *= 100;
                break;
            case AICOND_04:
                m_ppConditionLIST[iC]->st04.iDistance *= 100;
                break;
            case AICOND_05:
                break;
            case AICOND_06:
            ...
            case AICOND_07:
                break;
            case AICOND_08:
                m_ppConditionLIST[iC]->st08.iDistance *= 100;
                if (sCondH.dwSize < sizeof(AICOND02)) {
                    _ASSERT(0);
                    return false;
                }
            ...
            case AICOND_16:
                break;
            case AICOND_18:
                m_ppConditionLIST[iC]->st18.iDistance *= 100;
                break;
        }
    }
    ...
    for (int iA = 0; iA < m_iActionCNT; iA++) {
        ...
        fread(&m_ppActionLIST[iA]->m_pDATA[sizeof(stActHead)],
            sizeof(BYTE),
            sActionH.dwSize - sizeof(stActHead),
            fp);
        ...
        switch (sActionH.Type) {
            ...
            case AIACT_02: {
                ...
                // LogString( 0xffff,"AI02 STR[%d:%d] :: %s\n", iLangCol, m_ppActionLIST[ iA
                // ]->st02.iStrID-1, pNewACT->szCon );
            ...
            case AIACT_03:
                m_ppActionLIST[iA]->st03.iDistance *= 100;
                break;
            case AIACT_04:
                m_ppActionLIST[iA]->st04.iDistance *= 100;
                break;
            case AIACT_05:
                break;
            case AIACT_06:
                m_ppActionLIST[iA]->st06.iDistance *= 100;
                break;
            case AIACT_07:
                break;
            case AIACT_08:
                m_ppActionLIST[iA]->st08.iDistance *= 100;
                break;
            case AIACT_09:
                break;
            case AIACT_10:
                break;
            case AIACT_11:
                m_ppActionLIST[iA]->st11.iDistance *= 100;
                break;
            case AIACT_12:
                break;
            case AIACT_13:
                break;
            case AIACT_14:
                m_ppActionLIST[iA]->st14.iDistance *= 100;
                break;
            case AIACT_15:
                break;
            case AIACT_16:
            ...
            case AIACT_19:
                break;
            case AIACT_20:
                m_ppActionLIST[iA]->st20.iDistance *= 100;
                break;
...
#else
bool
CAI_EVENT::Load(CFileSystem* pFileSystem, STBDATA* pSTB, int iLangCol) {
    char szStr[AIG_NAME_MAX + 1];
    ...
    for (int iA = 0; iA < m_iActionCNT; iA++) {
        ...
        switch (sActionH.Type) {
            ...
            case AIACT_03:
                ((AIACT03*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_04:
                ((AIACT04*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_05:
                break;
            case AIACT_06:
                ((AIACT06*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_07:
                break;
            case AIACT_08:
                ((AIACT08*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_09:
                break;
            case AIACT_10:
                break;
            case AIACT_11:
                ((AIACT11*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_12:
                break;
            case AIACT_13:
                break;
            case AIACT_14:
                ((AIACT14*)m_ppActionLIST[iA])->iDistance *= 100;
                break;
            case AIACT_15:
                break;
            case AIACT_16:
...
//-------------------------------------------------------------------------------------------------
bool
CAI_EVENT::Check(t_AIPARAM* pAIParam) {
    for (int iC = 0; iC < m_iConditionCNT; iC++) {
        // check condition ...
        if (!g_FuncCOND[(m_ppConditionLIST[iC]->m_Header.Type & 0x00ff)].m_fpCondition(
                &m_ppConditionLIST[iC]->m_Header,
                pAIParam))
            return false;
    }
    ...
    // doing action ...
    for (int iA = 0; iA < m_iActionCNT; iA++) {
        g_FuncACTION[(m_ppActionLIST[iA]->m_Header.Type & 0x00ff)].m_fpAction(
            &m_ppActionLIST[iA]->m_Header,
            pAIParam);
    }
...
#ifdef __SERVER
bool
CAI_PATTERN::Load(FILE* fp, STBDATA* pSTB, int iLangCol) {
    stPattern Pattern;
...
//-------------------------------------------------------------------------------------------------
bool
CAI_PATTERN::Load(CFileSystem* pFileSystem, STBDATA* pSTB, int iLangCol) {
    stPattern Pattern;
...
//-------------------------------------------------------------------------------------------------
void
CAI_PATTERN::Check(t_AIPARAM* pAIParam) {
...
#ifdef __SERVER
bool
CAI_FILE::Load(char* szFileName, STBDATA* pSTB, int iLangCol) {
    FILE* fp;
...
//-------------------------------------------------------------------------------------------------
void
CAI_FILE::AI_Check(WORD wPattern, CAI_OBJ* pSourCHAR, CAI_OBJ* pDestCHAR, int iDamage) {
...
//-------------------------------------------------------------------------------------------------
void
CAI_FILE::AI_WhenCREATED(CAI_OBJ* pSourCHAR) {
    AI_Check(0, pSourCHAR);
}

void
CAI_FILE::AI_WhenSTOP(CAI_OBJ* pSourCHAR) {
...
#endif
    if (lCurTime - pSourCHAR->Get_AICheckTIME(0) < m_ulCheckStopAI)
        return;
    pSourCHAR->Set_AICheckTIME(0, lCurTime);

    AI_Check(1, pSourCHAR);
}

void
CAI_FILE::AI_WhenAttackMOVE(CAI_OBJ* pSourCHAR, CAI_OBJ* pDestCHAR) {
    AI_Check(2, pSourCHAR, pDestCHAR);
}
...
CAI_FILE::AI_WhenDAMAGED(CAI_OBJ* pSourCHAR, CAI_OBJ* pDestCHAR, int iDamage) {
    ...
    AI_Check(3, pSourCHAR, pDestCHAR, iDamage);
}

void
CAI_FILE::AI_WhenKILL(CAI_OBJ* pSourCHAR, CAI_OBJ* pDestCHAR, int iDamage) {
    AI_Check(4, pSourCHAR, pDestCHAR, iDamage);
}

void
CAI_FILE::AI_WhenDEAD(CAI_OBJ* pSourCHAR, CAI_OBJ* pDestCHAR, int iDamage) {
    AI_Check(5, pSourCHAR, pDestCHAR, iDamage);
}
