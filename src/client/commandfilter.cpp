...
//----------------------------------------------------------------------------------------------------
CObjCommand*
CCommandFilter::GetCommandObject(int iObjectType) {
...
//----------------------------------------------------------------------------------------------------
bool
CCommandFilter::CanSendAttackCommand() {
    return false;
}
...
//----------------------------------------------------------------------------------------------------
bool
CCommandFilter::CanSendSelfSkillCommand(int iSkillSlot) {
...
//----------------------------------------------------------------------------------------------------
bool
CCommandFilter::CanSendTargetSkillCommand(int iClientTarget, int iSkillSlot) {
    if (m_pPrevCommand == NULL)
        return true;
...
//----------------------------------------------------------------------------------------------------
bool
CCommandFilter::CanSendPositionSkillCommand(D3DVECTOR& PosTO, int iSkillSlot) {
    if (m_pPrevCommand == NULL)
        return true;
