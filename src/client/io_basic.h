...
public:
    ...
    HNODE Get_SKELETON(bool bFemale) {
        return m_SKELETON.Get_DATAUseKEY((bFemale) ? m_SkelFEMALE : m_SkelMALE);
    }
    HNODE Get_PetSKELETON(int iPetType) { return m_SKELETON.Get_DATAUseKEY(m_SkelPET[iPetType]); }
