...
struct STR_QUEST_DATA {
    ...
    BYTE btOp; /// iData값에 대한 비교방법. 0 = 같다, 1 = 크다, 2 = 크거나 같다. 3=작다, 4=작거나
               /// 같다, (이후 액션쪽) 5 = 값바꿈, 6 = 증가(주어진 만큼), 7 = 감소, 8 = 스위치 Off,
               /// 9 = 스위치 On
};
...
struct STR_ITEM_DATA {
    ...
    BYTE btOp; /// iRequestCnt에 대한 OP.  0 = 같다, 1 = 크다, 2 = 크거나 같다. 3=작다, 4=작거나
               /// 같다.
};
...
struct STR_COND_008 {
    ...
    BYTE btOp; /// ulTime에 대한 비교방법. 0 = 같다, 1 = 크다, 2 = 크거나 같다. 3=작다, 4=작거나
               /// 같다.
};
