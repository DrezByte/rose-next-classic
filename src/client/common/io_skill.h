...
#define SKILL_DISTANCE(I) g_SkillList.m_SkillDATA.get_int32(I, 6)
#define SKILL_WARP_PLANET_NO(I) g_SkillList.m_SkillDATA.get_int32(I, 6)

#define SKILL_CLASS_FILTER(I) g_SkillList.m_SkillDATA.get_int32(I, 7)
#define SKILL_SCOPE(S) g_SkillList.m_SkillDATA.get_int32(S, 8)
#define SKILL_POWER(S) g_SkillList.m_SkillDATA.get_int32(S, 9)
#define SKILL_ITEM_MAKE_NUM SKILL_POWER
#define SKILL_HARM(I) g_SkillList.m_SkillDATA.get_int32(I, 10)

#define SKILL_STATE_STB(I, C) g_SkillList.m_SkillDATA.get_int32(I, 11 + C)
#define SKILL_STATE_STB1(I) g_SkillList.m_SkillDATA.get_int32(I, 11)
#define SKILL_STATE_STB2(I) g_SkillList.m_SkillDATA.get_int32(I, 12)
#define SKILL_SUCCESS_RATIO(I) g_SkillList.m_SkillDATA.get_int32(I, 13)
#define SKILL_DURATION(I) g_SkillList.m_SkillDATA.get_int32(I, 14)
#define SKILL_DAMAGE_TYPE(S) g_SkillList.m_SkillDATA.get_int32(S, 15)
...
#define SKILL_RELOAD_TYPE(S) g_SkillList.m_SkillDATA.get_int32(S, 27) // 스킬여백
...
#define SKILL_LEVELUP_NEED_ZULY(I) g_SkillList.m_SkillDATA.get_int32(I, 85)

#define SKILL_ATTRIBUTE(I) \
    g_SkillList.m_SkillDATA.get_int32(I, 86) /// 1 : 아바타 스킬 , 2: PAT스킬 , 3: 공통 스킬
