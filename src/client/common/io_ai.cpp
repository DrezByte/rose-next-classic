...
//-------------------------------------------------------------------------------------------------
bool
CAI_LIST::Load(char* szBaseDIR, char* szSTBFile, char* szLangSTB, int iLangCol) {
    char* pFullPath;
...
//-------------------------------------------------------------------------------------------------
void
CAI_LIST::AI_Created(int iAI_IDX, CObjCHAR* pSourCHAR) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
...
void
CAI_LIST::AI_Stop(int iAI_IDX, CObjCHAR* pSourCHAR) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
...
void
CAI_LIST::AI_AttackMove(int iAI_IDX, CObjCHAR* pSourCHAR, CObjCHAR* pDestCHAR) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
...
void
CAI_LIST::AI_Damaged(int iAI_IDX, CObjCHAR* pSourCHAR, CObjCHAR* pDestCHAR, int iDamage) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
...
void
CAI_LIST::AI_Kill(int iAI_IDX, CObjCHAR* pSourCHAR, CObjCHAR* pDestCHAR, int iDamage) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
...
void
CAI_LIST::AI_Dead(int iAI_IDX, CObjCHAR* pSourCHAR, CObjCHAR* pDestCHAR, int iDamage) {
    if (iAI_IDX <= 0)
        return;
    if (iAI_IDX >= m_nAICNT)
        return;
