        ...
        case 0: // 삭제.
            ...
            /*#ifndef __SERVER
                        g_itMGR.AppendChatMsg( CStr::Printf(
                                                    "%s 완료하였습니다",
                                                    CStringManager::GetSingleton().GetQuestName(
            pREWD->m_Rewd000.iQuestSN ) ) , IT_MGR::CHAT_TYPE_QUEST
                                            );
            #endif	*/
...
CQuestTRIGGER::Proc(tQST_PARAM* pPARAM, bool bDoReward) {
    ...
    // if ( !bDoReward )
    {
        ...
        // if ( !bDoReward ) 05.05.21 icarus:: 보상없이 체크만 할경우 화면에 출력할 보상 목록을
        // 작성한다... 	return true;
    }
#endif
