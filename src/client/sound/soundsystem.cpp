...
//-------------------------------------------------------------------------------------------------
bool
CSoundSYSTEM::Load_FILE(tagFileDATA<t_sounddata*>* pDATA) {
    short nMixCNT = 1;
    pDATA->m_DATA = m_SOUND.LoadSoundData(pDATA->m_FileName.Get(), nMixCNT);
    return (pDATA->m_DATA != NULL);
}
void
CSoundSYSTEM::Free_FILE(tagFileDATA<t_sounddata*>* pDATA) {
    m_SOUND.FreeSoundData(pDATA->m_DATA);
}

//-------------------------------------------------------------------------------------------------
bool
CSoundSYSTEM::KEY_PlaySound(unsigned int uiKEY) {
...
//-------------------------------------------------------------------------------------------------
bool
CSoundSYSTEM::IDX_PlaySound(short nIndex) {
...
//-------------------------------------------------------------------------------------------------
bool
CSoundSYSTEM::PlaySoundFile(char* szFileName) {
