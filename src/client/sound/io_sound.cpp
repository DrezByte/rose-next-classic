...
//-------------------------------------------------------------------------------------------------
bool
CSoundLIST::Load(char* szSTBFile, short nFileNameColNO) {
    CGameSTB fSTB;
...
//-------------------------------------------------------------------------------------------------
bool
CSoundLIST::Load_FILE(tagFileDATA<tagSndFILE*>* pDATA) {
    ...
    if (pDATA->m_DATA) {
        pDATA->m_DATA->m_pSoundData =
            m_SOUND.LoadSoundData(pDATA->m_FileName.Get(), pDATA->m_DATA->m_nMixCNT);
...
void
CSoundLIST::Free_FILE(tagFileDATA<tagSndFILE*>* pDATA) {
...
//-------------------------------------------------------------------------------------------------
bool
CSoundLIST::KEY_PlaySound3D(t_HASHKEY HashKEY,
...
bool
CSoundLIST::KEY_StopSound3DLoop(t_HASHKEY HashKEY) {
    tagSndFILE* pSoundData = Get_DATAUseKEY(HashKEY);
...
bool
CSoundLIST::IDX_StopSound3DLoop(short nIndex) {
    tagSndFILE* pSoundData = Get_DATAUseIDX(nIndex);
...
bool
CSoundLIST::IDX_PlaySound3D(short nIndex,
    const D3DXVECTOR3& posWorld,
    const D3DXVECTOR3* velWorld,
    float fMinDistance,
    float fMaxDistance) {
...
//-------------------------------------------------------------------------------------------------
bool
CSoundLIST::PlaySoundFile(char* szFileName, short nMaxMixCNT) {
...
//-------------------------------------------------------------------------------------------------
bool
CSoundLIST::PlaySoundFile3D(char* szFileName,
    const D3DXVECTOR3& posWorld,
    short nMaxMixCNT,
    const D3DXVECTOR3* velWorld,
    float fMinDistance,
...
void
CSoundLIST::SubSoundFile(t_HASHKEY uiKEY) {
    tagFileDATA<tagSndFILE*>* pSndFileDATA = KEY_Find_DATA(uiKEY);
    if (pSndFileDATA) {
        if (pSndFileDATA->m_DATA) {
