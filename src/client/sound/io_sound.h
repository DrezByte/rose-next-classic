...
public:
    ...
    bool KEY_PlaySound3D(t_HASHKEY HashKEY,
        ...
        const D3DXVECTOR3* velWorld = 0,
        float fMinDistance = SOUND_DEFAULT_MIN_DISTANCE,
        float fMaxDistance = SOUND_DEFAULT_MAX_DISTANCE);
    bool KEY_PlaySound3D(t_HASHKEY HashKEY,
        const D3DXVECTOR3& posWorld,
        int iVolume,
        int iPan = SOUND_PAN_CENTER,
        const D3DXVECTOR3* velWorld = 0,
        float fMinDistance = SOUND_DEFAULT_MIN_DISTANCE,
        float fMaxDistance = SOUND_DEFAULT_MAX_DISTANCE);

    bool IDX_PlaySound(short nIndex);
    bool IDX_PlaySound3D(short nIndex,
        const D3DXVECTOR3& posWorld,
        const D3DXVECTOR3* velWorld = 0,
        float fMinDistance = SOUND_DEFAULT_MIN_DISTANCE,
        float fMaxDistance = SOUND_DEFAULT_MAX_DISTANCE);
    ...
    bool PlaySoundFile3D(char* szFileName,
        const D3DXVECTOR3& posWorld,
        short nMaxMixCNT = 1,
        const D3DXVECTOR3* velWorld = 0,
        float fMinDistance = SOUND_DEFAULT_MIN_DISTANCE,
