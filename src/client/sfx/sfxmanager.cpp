...
bool
CSFXManager::DeleteSFX(ISFX* pSFX) {
...
ISFX*
CSFXManager::FindSFXWithType(int iSFXType) {
...
bool
CSFXManager::StartWideScreenEffect() {
...
void
CSFXManager::StopWideScreenEffect() {
