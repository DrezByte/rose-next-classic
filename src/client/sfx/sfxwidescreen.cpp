...
void
CSFXWideScreen::SetScreenSize(int iWidth, int iHeight) {
    m_iWidth = iWidth;
    m_iHeight = iHeight;
}
...
CSFXWideScreen::Init() {
    ...
    // m_hSFXTexture = ::loadTexture( "3Ddata\\CUTSCENE\\WARP01\\screen_black01.dds",
    // "3Ddata\\CUTSCENE\\WARP01\\screen_black01.dds", 1, 0 ); if( m_hSFXTexture == 0 )
    //{
    //	#ifdef _DEBUG
