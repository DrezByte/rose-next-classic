...
bool
CAppMsgQ::AddMsgToMouseQ(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
...
bool
CAppMsgQ::AddMsgToKeyboardQ(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
    tagWNDMSG msg;
    msg.lParam = lParam;
    msg.uiMsg = uiMsg;
    msg.wParam = wParam;
...
bool
CAppMsgQ::AddMsgToQ(UINT uiMsg, WPARAM wParam, LPARAM lParam) {
    switch (uiMsg) {
            ///
            /// Mouse msg
            ///
...
///
bool
CAppMsgQ::GetMouseMsgFromQ(tagWNDMSG& WndMsg) {
...
bool
CAppMsgQ::GetKeyboardMsgFromQ(tagWNDMSG& WndMsg) {
