...
public:
    ...
    virtual bool ClickObject(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 {
        *(int*)0 = 10;
    };
    virtual bool RButtonDown(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 {
        *(int*)0 = 10;
    };
    virtual bool DBClickObject(int iTarget, D3DXVECTOR3& PickPos, WPARAM wParam) = 0 {
        *(int*)0 = 10;
    };
    ...
    virtual void SetTargetObject(int iTargetType,
        ...
        D3DVECTOR& pickPos,
        DWORD wVKeyState,
        bool bDBClick = false) = 0 {
        *(int*)0 = 10;
    };
    virtual void SetTargetObject_Normal(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false) = 0 {
        *(int*)0 = 10;
    };
    virtual void SetTargetObject_CtrlClick(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false) = 0 {
        *(int*)0 = 10;
    };
    virtual void SetTargetObject_ShiftClick(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false) = 0 {
        *(int*)0 = 10;
...
public:
    ...
    /*override*/ void SetTargetObject(int iTargetType,
        ...
        DWORD wVKeyState,
        bool bDBClick = false);
    /*override*/ void SetTargetObject_Normal(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false);
    /*override*/ void SetTargetObject_CtrlClick(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false);
    /*override*/ void SetTargetObject_ShiftClick(int iTargetType,
        int iTargetObj,
        D3DVECTOR& pickPos,
        bool bDBClick = false);
};
...
public:
    ...
    //----------------------------------------------------------------------------------------------------
    void SetCurrentActiveSkillSlot(int iSkillSlotNO) {
        m_pUserInput->SetCurrentActiveSkillSlot(iSkillSlotNO);
    };
