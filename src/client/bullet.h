...
public:
    ...
    char* Make_ZNAME(int iCreateOrder, short nPartIdx) {
        return CStr::Printf(NAME_BULLET, iCreateOrder, nPartIdx);
    }

    virtual bool Init(CObjCHAR* pSour,
        CObjCHAR* pDest,
        int iEffectIDX,
        bool bLinkToPoint = false,
        int iPointNO = 0,
        bool bDummy = false,
        int iSkillIDX = 0) = 0 {
        *(int*)0 = 10;
...
public:
    ...
    bool Init(CObjCHAR* pSour,
        CObjCHAR* pDest,
        int iEffectIDX,
        bool bLinkToLeftHand = false,
        int iPointNO = 0,
        bool bDummy = false,
        int iSkillIDX = 0);
    bool Init(CObjCHAR* pSour,
...
public:
    ...
    CBullet* Add_BULLET(CObjCHAR* pSour,
        CObjCHAR* pDest,
        int iEffectIDX,
        bool bLinkToPoint = false,
        int iPointNO = 0,
        D3DXVECTOR3 PosTo = D3DXVECTOR3(0.0f, 0.0f, 0.0f),
        bool bUseTargetPos = false,
        bool bDummy = false,
        int iSkillIDX = 0);
    void ProcBULLET();
};
