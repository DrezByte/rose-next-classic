...
public:
    ...
    virtual bool OpenFile(const char* pFileName, int iOpenType = OPEN_READ_BIN) = 0 {
        *(int*)0 = 10;
    };
...
public:
    ...
    virtual void WriteFloat2(float* x, float* y, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
    virtual void WriteFloat3(float* lpBuf, const char* strValueName = NULL) = 0 { *(int*)0 = 10; };
    virtual void WriteFloat3(float* x, float* y, float* z, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
    virtual void WriteFloat4(float* lpBuf, const char* strValueName = NULL) = 0 { *(int*)0 = 10; };
    virtual void
    WriteFloat4(float* x, float* y, float* z, float* w, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };

    virtual void WriteChar(char* pValue, const char* strValueName = NULL) = 0 { *(int*)0 = 10; };
    virtual void WriteByte(unsigned char* pValue, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
    ...
    virtual void WriteInt64(__int64* pValue, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };

    virtual void WriteUInt16(unsigned short* pValue, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
    virtual void WriteUInt32(unsigned int* pValue, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
    virtual void WriteUInt64(unsigned __int64* pValue, const char* strValueName = NULL) = 0 {
        *(int*)0 = 10;
    };
};
