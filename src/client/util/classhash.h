...
template<class t_HASHDATA>
bool
classHASH<t_HASHDATA>::GetFirst(t_HASHKEY* pHashKey, t_HASHDATA* pHashData) {
    for (int iL = 0; iL < m_iEntryCount; iL++)
...
template<class t_HASHDATA>
bool
classHASH<t_HASHDATA>::Insert(t_HASHKEY ulHashKey, t_HASHDATA HashData) {
...
template<class t_HASHDATA>
t_HASHDATA
classHASH<t_HASHDATA>::Delete(t_HASHKEY ulHashKey) {
    tagHASH<t_HASHDATA>*pHEAD, *pNODE;
...
template<class t_HASHDATA>
int
classHASH<t_HASHDATA>::GetEntryCount(int iEntryIDX) {
    int iCnt = 0;
    tagHASH<t_HASHDATA>* pNODE;
...
template<class t_HASHDATA>
tagHASH<t_HASHDATA>*
classHASH<t_HASHDATA>::SearchContinue(tagHASH<t_HASHDATA>* pStartNODE, t_HASHKEY ulHashKey) {
    tagHASH<t_HASHDATA>* pNODE;
...
template<class t_HASHDATA>
tagHASH<t_HASHDATA>*
classHASH<t_HASHDATA>::Search(t_HASHKEY ulHashKey) {
    tagHASH<t_HASHDATA>* pNODE;
...
template<class t_HASHDATA>
bool
classHASH<t_HASHDATA>::Delete(t_HASHKEY ulHashKey, t_HASHDATA HashData) {
    tagHASH<t_HASHDATA>*pHEAD, *pNODE;
...
template<class t_HASHDATA>
tagHASH<t_HASHDATA>*
classHASH<t_HASHDATA>::Search(t_HASHKEY ulHashKey, t_HASHDATA HashData) {
    tagHASH<t_HASHDATA>* pNODE;
