...
bool
CFileSystemNormal::OpenFile(const char* fname, int iMode) {
...
// Overload function
int
CFileSystemNormal::Read(void* lpBuf, unsigned int nCount) {
...
void
CFileSystemNormal::Write(const void* lpBuf, unsigned int nCount) {
...
bool
CFileSystemNormal::Seek(long lOff, unsigned int nFrom) {
    ...
    switch (nFrom) {
        case FILE_POS_SET:
            iResult = fseek(m_pFile, lOff, SEEK_SET);
            break;
        case FILE_POS_CUR:
            iResult = fseek(m_pFile, lOff, SEEK_CUR);
            break;
        case FILE_POS_END:
            iResult = fseek(m_pFile, lOff, SEEK_END);
            break;
    }
...
long
CFileSystemNormal::Tell() {
    assert((m_pFile != NULL) && "file desc is null");
    return ftell(m_pFile);
}

bool
CFileSystemNormal::IsEOF() {
    assert((m_pFile != NULL) && "file desc is null");
    return feof(m_pFile);
}

int
CFileSystemNormal::ReadStringByNullLength() {
...
int
CFileSystemNormal::ReadStringByNull(char* lpBuf) {
...
void
CFileSystemNormal::WriteStringByNull(const char* pStr) {
...
int
CFileSystemNormal::ReadPascalStringLength() {
    assert(m_pFile && "Write string to FileStream failed, file description is null");
...
int
CFileSystemNormal::ReadPascalString(char* lpBuf, int iBufferLength) {
...
void
CFileSystemNormal::WritePascalString(const char* pStr) {
    assert((pStr != NULL) && "Write string to FileStream failed , Input string is null");
    assert(m_pFile && "Write string to FileStream failed, file description is null");
...
bool
CFileSystemNormal::ReadToMemory() {
    if (m_pFile == NULL) {
        m_strFileName = std::string("");
        return false;
    }
...
bool
CFileSystemNormal::IsExist(const char* pFileName) {
...
int
CFileSystemNormal::ReadFloat(float* pValue) {
    return Read(pValue, sizeof(float));
}

int
CFileSystemNormal::ReadFloat2(float* lpBuf) {
    return Read(lpBuf, sizeof(float) * 2);
}

int
CFileSystemNormal::ReadFloat2(float* x, float* y) {
    int iSize = 0;
...
int
CFileSystemNormal::ReadFloat3(float* lpBuf) {
    return Read(lpBuf, sizeof(float) * 3);
}

int
CFileSystemNormal::ReadFloat3(float* x, float* y, float* z) {
    int iSize = 0;
    iSize += Read(x, sizeof(float));
    iSize += Read(y, sizeof(float));
...
int
CFileSystemNormal::ReadFloat4(float* lpBuf) {
    return Read(lpBuf, sizeof(float) * 4);
}

int
CFileSystemNormal::ReadFloat4(float* x, float* y, float* z, float* w) {
    int iSize = 0;
    iSize += Read(x, sizeof(float));
    iSize += Read(y, sizeof(float));
    iSize += Read(z, sizeof(float));
...
int
CFileSystemNormal::ReadChar(char* pValue) {
    return Read(pValue, sizeof(char));
}

int
CFileSystemNormal::ReadByte(unsigned char* pValue) {
    return Read(pValue, sizeof(unsigned char));
}

int
CFileSystemNormal::ReadBool(bool* pValue) {
    return Read(pValue, sizeof(bool));
}

int
CFileSystemNormal::ReadInt16(short* pValue) {
    return Read(pValue, sizeof(short));
}

int
CFileSystemNormal::ReadInt32(int* pValue) {
    return Read(pValue, sizeof(int));
}

int
CFileSystemNormal::ReadInt64(__int64* pValue) {
    return Read(pValue, sizeof(__int64));
}

int
CFileSystemNormal::ReadUInt16(unsigned short* pValue) {
    return Read(pValue, sizeof(unsigned short));
}

int
CFileSystemNormal::ReadUInt32(unsigned int* pValue) {
    return Read(pValue, sizeof(unsigned int));
}

int
CFileSystemNormal::ReadUInt64(unsigned __int64* pValue) {
    return Read(pValue, sizeof(unsigned __int64));
}

// Specific write method
void
CFileSystemNormal::WriteFloat(float* pValue, const char* strValueName) {
    Write(pValue, sizeof(float));
}

void
CFileSystemNormal::WriteFloat2(float* lpBuf, const char* strValueName) {
    Write(lpBuf, sizeof(float) * 2);
}

void
CFileSystemNormal::WriteFloat2(float* x, float* y, const char* strValueName) {
    Write(x, sizeof(float));
    Write(y, sizeof(float));
}

void
CFileSystemNormal::WriteFloat3(float* lpBuf, const char* strValueName) {
    Write(lpBuf, sizeof(float) * 3);
}

void
CFileSystemNormal::WriteFloat3(float* x, float* y, float* z, const char* strValueName) {
    Write(x, sizeof(float));
    Write(y, sizeof(float));
...
void
CFileSystemNormal::WriteFloat4(float* lpBuf, const char* strValueName) {
    Write(lpBuf, sizeof(float) * 4);
}

void
CFileSystemNormal::WriteFloat4(float* x, float* y, float* z, float* w, const char* strValueName) {
    Write(x, sizeof(float));
    Write(y, sizeof(float));
    Write(z, sizeof(float));
...
void
CFileSystemNormal::WriteChar(char* pValue, const char* strValueName) {
    Write(pValue, sizeof(char));
}

void
CFileSystemNormal::WriteByte(unsigned char* pValue, const char* strValueName) {
    Write(pValue, sizeof(unsigned char));
}

void
CFileSystemNormal::WriteBool(bool* pValue, const char* strValueName) {
    Write(pValue, sizeof(bool));
}

void
CFileSystemNormal::WriteInt16(short* pValue, const char* strValueName) {
    Write(pValue, sizeof(short));
}

void
CFileSystemNormal::WriteInt32(int* pValue, const char* strValueName) {
    Write(pValue, sizeof(int));
}

void
CFileSystemNormal::WriteInt64(__int64* pValue, const char* strValueName) {
    Write(pValue, sizeof(__int64));
}

void
CFileSystemNormal::WriteUInt16(unsigned short* pValue, const char* strValueName) {
    Write(pValue, sizeof(unsigned short));
}

void
CFileSystemNormal::WriteUInt32(unsigned int* pValue, const char* strValueName) {
    Write(pValue, sizeof(unsigned int));
}

void
CFileSystemNormal::WriteUInt64(unsigned __int64* pValue, const char* strValueName) {
