...
Socket_Error(char* szMsg) {
    ...
    switch (iErr) {
        case WSAEAFNOSUPPORT:
            g_LOG.OutputString(LOG_DEBUG, "The specified address family is not supported.");
            break;
        case WSAEFAULT:
            g_LOG.OutputString(LOG_DEBUG, "The lpWSAData is not a valid pointer.\n");
            g_LOG.OutputString(LOG_DEBUG,
        ...
        case WSAEINPROGRESS:
            ...
            break;
        case WSAEMFILE:
            g_LOG.OutputString(LOG_DEBUG, "No more socket descriptors are available.");
            break;
        case WSAENETDOWN:
            g_LOG.OutputString(LOG_DEBUG,
        ...
        case WSAEPROTONOSUPPORT:
            g_LOG.OutputString(LOG_DEBUG, "The specified protocol is not supported.");
            break;
        case WSAEPROTOTYPE:
            g_LOG.OutputString(LOG_DEBUG,
        ...
        case WSAENETRESET:
            ...
            break;
        case WSAENOTSOCK:
            g_LOG.OutputString(LOG_DEBUG, "The descriptor is not a socket. ");
            break;
        case WSAEOPNOTSUPP:
            g_LOG.OutputString(LOG_DEBUG,
        ...
        case WSAECONNRESET:
            ...
            break;
        default:; // LogString (LOG_DEBUG, "Unknown socket iError. CODE[ 0x%X, %d ]\n", iErr, iErr);
    }
