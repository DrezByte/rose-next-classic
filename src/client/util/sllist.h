...
template<class dType>
void
classSLLIST<dType>::AppendNodeList(classSLLIST<dType>* pList) {
    if (m_pHEAD == NULL) {
...
template<class dType>
classSLLNODE<dType>*
classSLLIST<dType>::AllocNAppend(dType DATA) {
...
template<class dType>
classSLLNODE<dType>*
classSLLIST<dType>::AllocNAppend(void) {
    classSLLNODE<dType>* pNewNode;
...
template<class dType>
bool
classSLLIST<dType>::DeleteHeadNFree(void) {
...
template<class dType>
void
classSLLIST<dType>::AppendNode(classSLLNODE<dType>* NodeToAdd) {
    if (m_pHEAD == NULL) {
...
template<class dType>
classSLLNODE<dType>*
classSLLIST<dType>::DeleteHead(void) {
...
template<class dType>
classSLLNODE<dType>*
classSLLIST<dType>::GetNextNode(classSLLNODE<dType>* pCurNode) {
    if (pCurNode == NULL)
        return NULL;
...
template<class dType>
void
classSLLIST<dType>::ClearListNFree() {
