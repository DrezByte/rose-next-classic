...
public:
    ...
    classDLLNODE<dType>* GetNextNode(classDLLNODE<dType>* CurrentNode) {
        return CurrentNode->m_pNEXT;
    }
    classDLLNODE<dType>* GetPrevNode(classDLLNODE<dType>* CurrentNode) {
        return CurrentNode->m_pPREV;
    }
...
template<class dType>
void
classDLLIST<dType>::AppendNodeList(classDLLIST<dType>* pList) {
    if (m_pHEAD == NULL) {
...
template<class dType>
classDLLNODE<dType>*
classDLLIST<dType>::AllocNAppend(void) {
...
template<class dType>
classDLLNODE<dType>*
classDLLIST<dType>::AllocNAppend(dType DATA) {
    classDLLNODE<dType>* pNewNode;
...
template<class dType>
void
classDLLIST<dType>::DeleteNFree(classDLLNODE<dType>* pNodeToDelete) {
    if (pNodeToDelete) {
...
template<class dType>
void
classDLLIST<dType>::AppendNode(classDLLNODE<dType>* NodeToAdd) {
    if (m_pHEAD == NULL) {
...
template<class dType>
void
classDLLIST<dType>::DeleteNode(classDLLNODE<dType>* NodeToDel) {
    if (NodeToDel == NULL)
        return;
...
template<class dType>
void
classDLLIST<dType>::ReplaceNode(classDLLNODE<dType>* TargetNode,
    classDLLNODE<dType>* NodeToReplace) {
    if (TargetNode == NULL)
        return;
...
template<class dType>
void
classDLLIST<dType>::InsertNodeToPrev(classDLLNODE<dType>* TargetNode,
    classDLLNODE<dType>* NodeToIns) {
    if (TargetNode == NULL)
        return;
...
template<class dType>
void
classDLLIST<dType>::InsertNodeToNext(classDLLNODE<dType>* TargetNode,
    classDLLNODE<dType>* NodeToIns) {
    if (TargetNode == NULL)
        return;
...
template<class dType>
void
classDLLIST<dType>::ClearListNFree() {
    classDLLNODE<dType>* pNode;
