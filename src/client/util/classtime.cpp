...
//-------------------------------------------------------------------------------------------------
void
classTIME::InitStartTime() {
    m_i64StartTIME = GetCurrentAbsMilliSecond();
}

//-------------------------------------------------------------------------------------------------
DWORD
classTIME::GetPassAbsMilliSecond(void) {
...
//-------------------------------------------------------------------------------------------------
DWORD
classTIME::GetCurrentAbsSecond(void) {
    SYSTEMTIME st;
...
//-------------------------------------------------------------------------------------------------
DWORD
classTIME::GetPassAbsSecond(SYSTEMTIME& st) {
...
INT64
classTIME::GetCurrentAbsMilliSecond(void) {
    SYSTEMTIME st;
