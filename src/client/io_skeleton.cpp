...
//-------------------------------------------------------------------------------------------------
t_HASHKEY
CSKELETON::Add_SKELETON(char* szFileName) {
...
//-------------------------------------------------------------------------------------------------
bool
CSKELETON::Load_FILE(tagFileDATA<HNODE>* pHNODE) {
...
void
CSKELETON::Free_FILE(tagFileDATA<HNODE>* pHNODE) {
    if (pHNODE->m_DATA) {
