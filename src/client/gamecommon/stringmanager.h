...
/// 테이블 타입
//-----------------------------------------------------------------------------------------------
enum STRING_TABLE_TYPE { ITEM_TYPE_ST = 0, NORMAL_TYPE_ST = 1, QUEST_TYPE_ST = 2 };
...
/// 퀘스트 타입 스티링 테이블들
//-----------------------------------------------------------------------------------------------
enum QUEST_TYPE_TABLES { LIST_QUEST_S_TB = 0, LIST_STATUS_S, MAX_QUEST_TYPE_TB };
...
struct stNormalTypeTable: public stTypeTable {
    ...
    bool operator<(std::string& rhs) { return this->strKey < rhs; }
};
