...
CGameStateMovePlanet::Enter(int iPrevStateID) {
    ...
    /// setCameraPerspective( motion_camera, CAMERA_FOV(0), atof(CAMERA_ASPECT_RATIO(0)),
    /// CAMERA_NEAR_PLANE(0) * 100, CAMERA_FAR_PLANE(0) * 10000);
...
bool
CGameStateMovePlanet::On_WM_MOUSEWHEEL(WPARAM wParam, LPARAM lParam) {
...
void
CGameStateMovePlanet::Render_GameMENU() {
#ifdef _DEBUG
    {
