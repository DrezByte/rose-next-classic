...
void
CRoughMap::SetWorldOffset(float fX, float fY) {
    m_fWorldOffsetX = fX;
    m_fWorldOffsetY = fY;
}

void
CRoughMap::SetDetailLevel(int iLevel) {
...
bool
CRoughMap::Load(char* szMapName, int iZoneMapX, int iZoneMapY) {
...
bool
CRoughMap::LoadEngineObject(char* szMapName, int iZoneMapX, int iZoneMapY) {
