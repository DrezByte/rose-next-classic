...
enum class StatusEffectFlag : uint32_t {
	...
	Bad = Poisoned | DecreaseMoveSpeed | DecreaseAttackSpeed |
	DecreaseAttackPower | DecreaseDefense | DecreaseMagicRes |
	DecreaseHit | DecreaseCrit | DecreaseDodge | Dumb | Sleep |
	Faint,

	Good = IncreaseMaxHP | IncreaseMaxMP | IncreaseMoveSpeed | 
	IncreaseAttackSpeed | IncreaseAttackPower | IncreaseDefense | 
	IncreaseMagicRes | IncreaseHit | IncreaseCrit | IncreaseDodge | 
	ShieldDamage | AdditionalDamage | Disguise | Invisible,
...
{
	return static_cast<StatusEffectFlag>
