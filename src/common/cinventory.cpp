...
static t_EquipINDEX s_EquipIDX[] = {
    ...
    EQUIP_IDX_FACE_ITEM,			// ITEM_TYPE_FACE_ITEM = 1,		// 1	LIST_FACEITEM.stb 얼굴
장식 EQUIP_IDX_HELMET,				// ITEM_TYPE_HELMET,			// 2	LIST_CAP.stb
...
CInventory::AppendITEM(tagITEM& sITEM, short& nCurWeight) {
    ...
    // 중복될수 없는 장비아이템, PAT아이템 이나 보유한 아이템중에 같은 아이템이 없는 경우...빈슬롯
    // 할당...
