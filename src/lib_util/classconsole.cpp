...
//-------------------------------------------------------------------------------------------------
void
classCONSOLE::SetColor(WORD wColor) {
    ::SetConsoleTextAttribute(m_hConsole, wColor);
}

//-------------------------------------------------------------------------------------------------
char*
classCONSOLE::Printf(WORD wColor, char* fmt, ...) {
    this->Lock();
...
//-------------------------------------------------------------------------------------------------
void
classCONSOLE::Puts(WORD wColor, char* pStr) {
    DWORD Chars;
