...
template<typename T>
void
CDLList<T>::AppendNodeList(CDLList<T>* pList) {
    if (m_pHEAD == NULL) {
...
template<typename T>
void
CDLList<T>::DeleteNFree(tagNODE* pNodeToDelete) {
    if (pNodeToDelete) {
...
template<typename T>
void
CDLList<T>::AppendNode(tagNODE* pNodeToAdd) {
    if (m_pHEAD == NULL) {
...
template<typename T>
void
CDLList<T>::DeleteNode(tagNODE* pNodeToDel) {
    if (pNodeToDel == NULL)
        return;
...
template<typename T>
void
CDLList<T>::ReplaceNode(tagNODE* pTargetNode, tagNODE* pNodeToReplace) {
    if (pTargetNode == NULL)
        return;
...
template<typename T>
void
CDLList<T>::InsertNodeToPrev(tagNODE* pTargetNode, tagNODE* pNodeToIns) {
    if (pTargetNode == NULL)
        return;
...
template<typename T>
void
CDLList<T>::InsertNodeToNext(tagNODE* pTargetNode, tagNODE* pNodeToIns) {
    if (pTargetNode == NULL)
        return;
