...
public:
    ...
    CTObject* getParentPath(); /// Returns a path containing all the elements of this object, except
                               /// the last path component.
    CTObject*
    getPath(); /// Returns an ordered array of Objects containing the components of this TreePath.
    ...
    CTreePath* pathByAddingChild(CTObject
