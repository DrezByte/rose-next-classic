...
CTScrollBoxType::~CTScrollBoxType(void) {}
void
CTScrollBoxType::SetOffset(POINT pt) {
    m_ptOffset = pt;
}
void
CTScrollBoxType::SetTickMove(bool bTickMove) {
...
///*----------------------------------------------------------------------------------------------------------------------------*/
POINT
CTScrollBoxTypeVertical::GetMoveBoxPos(RECT MoveRange, int iValue, int iMax, int iExtent) {
    POINT ptRet = {0, 0};
...
POINT
CTScrollBoxTypeVertical::GetMoveBoxPosByScreenPoint(SIZE sizeScrollBox,
    RECT MoveRange,
    POINT ptMove,
    int iMax,
    int iExtent,
...
///*----------------------------------------------------------------------------------------------------------------------------*/
POINT
CTScrollBoxTypeHorizontal::GetMoveBoxPos(RECT MoveRange, int iValue, int iMax, int iExtent) {
    POINT ptRet = {0, 0};
...
POINT
CTScrollBoxTypeHorizontal::GetMoveBoxPosByScreenPoint(SIZE sizeScrollBox,
    RECT MoveRange,
    POINT ptMove,
    int iMax,
    int iExtent,
