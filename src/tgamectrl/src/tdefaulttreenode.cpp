...
bool
CTDefaultTreeNode::getAllowsChildren() {
    return m_bAllowChildren;
}

ITreeNode*
CTDefaultTreeNode::getChildAt(int childIndex) {
...
int
CTDefaultTreeNode::getChildCount() {
    return (int)m_children.size();
}

int
CTDefaultTreeNode::getIndex(ITreeNode* pNode) {
    std::vector<CTDefaultTreeNode*>::iterator iter;
    int iCount = 0;
...
ITreeNode*
CTDefaultTreeNode::getParent() {
    return m_pParentNode;
}

int
CTDefaultTreeNode::getLevel() {
...
void
CTDefaultTreeNode::setParent(CTDefaultTreeNode* pNode) {
    m_pParentNode = pNode;
}

void
CTDefaultTreeNode::add(ITreeNode* pNode) {
...
CTObject*
CTDefaultTreeNode::getUserObject() {
    return m_pUserObject;
}

ITreeNode*
CTDefaultTreeNode::getNextNode() {
    if (m_pParentNode) {
...
void
CTDefaultTreeNode::setAllowsChildren(bool bAllowChildren) {
    m_bAllowChildren = bAllowChildren;
}