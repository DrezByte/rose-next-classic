...
TGAMECTRL_API void
it_SetKeyboardInputType(short nInputType) {
    CTControlMgr::GetInstance()->SetKeyboardInputType(nInputType);
}

TGAMECTRL_API short
it_GetKeyboardInputType() {
    return CTControlMgr::GetInstance()->GetKeyboardInputType();
}
TGAMECTRL_API bool
it_Init(HWND hWnd, ITDraw* pDrawMgr, ITSound* pSoundMgr, ITFont* pFontMgr) {
...
TGAMECTRL_API void
it_SetCodePage(unsigned uiCodePage) {
...
//}
TGAMECTRL_API bool
it_IsVisibleImeCandidateWindow() {
