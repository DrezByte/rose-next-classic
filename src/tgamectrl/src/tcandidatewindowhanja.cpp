...
CTCandidateWindowHanja::Draw() {
    ...
    // pDraw->Draw( m_sPosition.x, m_sPosition.y, m_iWidth, 0, iGraphicID ,D3DCOLOR_ARGB(
    // 128,255,255,255) );
...
void
CTCandidateWindowHanja::AddCandidate(const char* pszCandidate) {
