...
void
CTRadioBox::RegisterCtrl(CTRadioButton* pCtrl) {
...
void
CTRadioBox::UnregisterCtrl(CTRadioButton* pCtrl) {
...
bool
CTRadioBox::SetPressedButton(unsigned int iID) {
    RADIOBUTTON_MAP_ITOR iter;
...
void
CTRadioBox::EventChangeSelect(unsigned int iID) {
    RADIOBUTTON_MAP_ITOR iter;
    CTRadioButton* pButton = NULL;
