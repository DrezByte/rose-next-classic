...
bool
CTCaption::Create(int iScrX, int iScrY, int iWidth, int iHeight) {
...
void
CTCaption::Update(POINT ptMouse) {
    if (!IsVision())
        return;
...
void
CTCaption::SetString(const char* pszString) {
...
//*------------------------------------------------*/
void
CTCaption::SetIcon(CTImage* pImage) {
    if (m_pIcon)
        delete m_pIcon;
    m_pIcon = pImage;
...
//*------------------------------------------------*/
void
CTCaption::SetImage(CTImage* pImage) {
    if (m_pImage)
        delete m_pImage;
    m_pImage = pImage;
...
void
CTCaption::SetCloseButton(CTButton* pButton) {
    if (m_pCloseButton)
        delete m_pCloseButton;
...
void
CTCaption::SetIconButton(CTButton* pButton) {
    if (m_pIconButton)
        delete m_pIconButton;
