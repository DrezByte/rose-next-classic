...
CTGuage::Draw() {
    ...
    if (m_bSizeFit) {
        m_pDrawImpl->DrawFitW((int)m_sPosition.x,
            (int)m_sPosition.y,
            m_iModuleID,
            m_iGuageImageID,
            iDrawGuageWidth,
        ...
        m_pDrawImpl->Draw((int)m_sPosition.x,
            (int)m_sPosition.y,
            m_iModuleID,
            m_iGuageImageID,
            iDrawGuageWidth,
...
void
CTGuage::SetText(const char* szTxt) {
    if (szTxt == NULL)
...
void
CTGuage::SetGuageImageID(int iImageID) {
