...
CTButton*
CTControlMgr::MakeButton(int ID,
    int iScrX,
    int iScrY,
    int iWidth,
    int iHeight,
...
CTPushButton*
CTControlMgr::MakePushButton(int ID,
    int iScrX,
    int iScrY,
    int iWidth,
    int iHeight,
...
CTCaption*
CTControlMgr::MakeCaption(int ID, int iScrX, int iScrY, int iWidth, int iHeight) {
...
CTDialog*
CTControlMgr::MakeDialog(int ID, int iScrX, int iScrY, int iWidth, int iHeight) {
...
CTEditBox*
CTControlMgr::MakeEditBox(int ID, int iScrX, int iScrY, int iWidth, int iHeight, int iCharWidth) {
...
CTListBox*
CTControlMgr::MakeListBox(int ID,
    int iScrX,
    int iScrY,
    int iWidth,
    int iHeight,
...
CJListBox*
CTControlMgr::MakeJListBox(int ID, int iScrX, int iScrY, int iWidth, int iHeight, int iItemHeight) {
...
CTScrollBar*
CTControlMgr::MakeScrollBar(int ID, int iScrX, int iScrY, int iWidth, int iHeight, int iType) {
...
CTScrollBox*
CTControlMgr::MakeScrollBox(int ID,
    int iWidth,
    int iHeight,
    int iGraphicID,
    int iModuleID,
...
CTStatic*
CTControlMgr::MakeStatic(int ID, int iScrX, int iScrY, int iWidth, int iHeight) {
...
CTRadioBox*
CTControlMgr::MakeRadioBox(int ID) {
...
CTRadioButton*
CTControlMgr::MakeRadioButton(int ID,
    int iScrX,
    int iScrY,
    int iWidth,
    int iHeight,
...
CTComboBox*
CTControlMgr::MakeComboBox(int ID, int iScrX, int iScrY, int iWidth, int iHeight) {
...
CJComboBox*
CTControlMgr::MakeJComboBox(int ID, int iScrX, int iScrY, int iWidth, int iHeight) {
...
*/
bool
CTControlMgr::MakeMsgBoxByXML(char* szIDD, CTMsgBox* pBase) {
...
int
CTControlMgr::GetNodeValueFromNamedNodeMapByName(MSXML::IXMLDOMNamedNodeMap* pNodeMap, char* name) {
    VARIANT value;
    string TempString;
    char szBuf[256];
...
float
CTControlMgr::GetNodeFloatValueFromNamedNodeMapByName(MSXML::IXMLDOMNamedNodeMap* pNodeMap,
    char* name) {
    VARIANT value;
    string TempString;
    char szBuf[256];
...
std::string
CTControlMgr::GetNodeStringValueFromNamedNodeMapByName(MSXML::IXMLDOMNamedNodeMap* pNodeMap,
    char* name) {
    VARIANT value;
    string TempString;
    char szBuf[512];
...
CTCheckBox*
CTControlMgr::MakeCheckBoxByXML(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CTButton*
CTControlMgr::MakeButtonByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    ...
    std::string strDisableGID =
        GetNodeStringValueFromNamedNodeMapByName(pNamedNodeMap, "DISABLEGID");
    ...
    CTButton* pBtn =
        MakeButton(iID, iScrX, iScrY, iWidth, iHeight, iNormalGID, iOverGID, iDownGID, iModuleID);
...
CTPushButton*
CTControlMgr::MakePushButtonByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    ...
    CTPushButton* pBtn = MakePushButton(iID,
        iScrX,
        iScrY,
        iWidth,
        iHeight,
...
void
CTControlMgr::MakeButtonByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
void
CTControlMgr::MakePushButtonByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
CTImage*
CTControlMgr::MakeImageByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
void
CTControlMgr::MakeImageByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    CTImage* pImage = MakeImageByXML2(pNode);
    if (pImage)
        pBase->Add(pImage);
}
CTCaption*
CTControlMgr::MakeCaptionByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
void
CTControlMgr::MakeCaptionByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
void
CTControlMgr::MakeStaticByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CTEditBox*
CTControlMgr::MakeEditBoxByXML2(MSXML::IXMLDOMNodePtr pNode) {
...
void
CTControlMgr::MakeEditBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
CTListBox*
CTControlMgr::MakeListBoxByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    ...
    CTListBox* pListBox =
        MakeListBox(iID, iScrX, iScrY, iWidth, iHeight, iExtent, iCharWidth, iCharHeight);
...
CZListBox*
CTControlMgr::MakeZListBoxByXML(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CJListBox*
CTControlMgr::MakeJListBoxByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
void
CTControlMgr::MakeListBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
void
CTControlMgr::MakeJListBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    CJListBox* pListBox = MakeJListBoxByXML2(pNode);
    if (pListBox)
        pBase->Add(pListBox);
}
CTComboBox*
CTControlMgr::MakeComboBoxByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
void
CTControlMgr::MakeComboBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
void
CTControlMgr::MakeJComboBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
void
CTControlMgr::AddTab(MSXML::IXMLDOMNodePtr pNode, CTabbedPane* pPane) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
void
CTControlMgr::AddTabbedPane(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    if (CTabbedPane* pPane = MakeTabbedPane(pNode))
        pBase->Add(pPane);
}

CTabbedPane*
CTControlMgr::MakeTabbedPane(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
CTScrollBar*
CTControlMgr::MakeScrollBarByXML2(MSXML::IXMLDOMNodePtr pNode, unsigned& iOutScrollModel) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
void
CTControlMgr::MakeScrollBarByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
CTScrollBox*
CTControlMgr::MakeScrollBoxByXML(MSXML::IXMLDOMNodePtr pNode, int iType) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CTRadioBox*
CTControlMgr::MakeRadioBoxByXML2(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
void
CTControlMgr::MakeRadioBoxByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
CTRadioButton*
CTControlMgr::MakeRadioButtonByXML2(MSXML::IXMLDOMNodePtr pNode, unsigned& iOutRadioBox) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CTRadioButton*
CTControlMgr::MakeRadioButtonByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
    unsigned iOutRadioBox = 0;
...
void
CTControlMgr::AddGuageByXML(MSXML::IXMLDOMNodePtr pNode, CTDialog* pBase) {
...
CTGuage*
CTControlMgr::MakeGuageByXML(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
CTPane*
CTControlMgr::MakePaneByXML(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
    HRESULT hr = pNode->get_attributes(&pNamedNodeMap);
...
void
CTControlMgr::SetCodePage(unsigned uiCodePage) {
    m_uiCodePage = uiCodePage;
}
unsigned
CTControlMgr::GetCodePage() {
    return m_uiCodePage;
}

CJTable*
CTControlMgr::MakeTableByXML(MSXML::IXMLDOMNodePtr pNode) {
    MSXML::IXMLDOMNamedNodeMap* pNamedNodeMap = NULL;
...
short
CTControlMgr::GetKeyboardInputType() {
    return m_nKeyboardInputType;
}

void
CTControlMgr::SetKeyboardInputType(short nInputType) {
