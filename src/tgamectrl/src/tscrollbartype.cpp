...
///*----------------------------------------------------------------------------------------------------------------------------*/
POINT
CTScrollBarTypeVertical::GetPrevButtonOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize) {
...
POINT
CTScrollBarTypeVertical::GetNextButtonOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE NextButtonSize) {
    POINT ptRet = {0, 0};
...
POINT
CTScrollBarTypeVertical::GetScrollBoxOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize,
    SIZE ScrollBoxSize) {
    POINT ptRet = {0, 0};
...
RECT
CTScrollBarTypeVertical::GetThumbMoveRange(POINT ptScrollBarPos,
    POINT ptNextButtonPos,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize,
    SIZE ScrollBoxSize) {
    RECT rcRet = {0, 0, 0, 0};
...
///*----------------------------------------------------------------------------------------------------------------------------*/
POINT
CTScrollBarTypeHorizontal::GetPrevButtonOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize) {
    POINT ptRet = ptScrollBarOffset;
...
POINT
CTScrollBarTypeHorizontal::GetNextButtonOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE NextButtonSize) {
    POINT ptRet = {0, 0};
...
POINT
CTScrollBarTypeHorizontal::GetScrollBoxOffset(POINT ptScrollBarOffset,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize,
    SIZE ScrollBoxSize) {
    POINT ptRet = {0, 0};
...
RECT
CTScrollBarTypeHorizontal::GetThumbMoveRange(POINT ptScrollBarPos,
    POINT ptNextButtonPos,
    SIZE ScrollBarSize,
    SIZE PrevButtonSize,
    SIZE ScrollBoxSize) {
