...
unsigned
CTCandidateWindowList::Process(unsigned uiMsg, WPARAM wParam, LPARAM lParam) {
    return 0;
}

void
CTCandidateWindowList::AddCandidate(const char* pszCandidate) {
...
void
CTCandidateWindowList::MoveWindow(POINT pt) {
    CWinCtrl::MoveWindow(pt);
    m_Candidats.MoveWindow(pt);
}

void
CTCandidateWindowList::Show() {
    CWinCtrl::Show();
    m_Candidats.Show();
}

void
CTCandidateWindowList::Hide() {
    CWinCtrl::Hide();
    m_Candidats.Hide();
}

void
CTCandidateWindowList::SetSelection(short n) {
