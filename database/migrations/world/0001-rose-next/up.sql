...
(
    ...
    from_character_id integer NOT NULL DEFAULT 0 REFERENCES character (id) ON DELETE CASCADE,
    to_character_id integer NOT NULL DEFAULT 0  REFERENCES character (id) ON DELETE CASCADE,
